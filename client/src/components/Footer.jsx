        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <div
                className={`text-gold font-roboto font-bold text-2xl text-nowrap whitespace-nowrap`}
              >
                <h1 className=""> JCI KENYA</h1>
              </div>

              <p class="text-base leading-relaxed text-gray-600 mt-7">
                JCI Kenya is a nonprofit organization empowering young active
                citizens to create positive change through leadership
                development, community service, and entrepreneurship, fostering
                sustainable impact across Kenya and beyond.
              </p>
